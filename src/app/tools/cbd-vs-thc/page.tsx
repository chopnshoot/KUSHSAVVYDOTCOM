        ...
        <section className="mt-16 pt-12 border-t border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link href="/tools/edible-dosage-calculator" className="card p-6 block hover:shadow-md transition-shadow">
              ...
              <p className="text-text-secondary text-sm">Calculate the right edible dose for your level</p>
            </Link>
            <Link href="/tools/terpene-guide" className="card p-6 block hover:shadow-md transition-shadow">
              ...
              <p className="text-text-secondary text-sm">Learn how terpenes work with cannabinoids</p>
            </Link>
          </div>
        </section>
