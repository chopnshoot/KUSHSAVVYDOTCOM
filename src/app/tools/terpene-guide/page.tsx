      ...
      <main className="max-w-4xl mx-auto px-4 py-12 md:py-20">
        <div className="text-center mb-10">
          ...
          <p className="text-text-secondary text-lg max-w-2xl mx-auto">
            Terpenes are the hidden drivers of your cannabis experience. Explore
            each one to understand its effects, aromas, and which strains are
            rich in it.
          </p>
        </div>
        ...
        <section className="mt-16 pt-12 border-t border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link href="/tools/strain-recommender" className="card p-6 block hover:shadow-md transition-shadow">
              ...
              <p className="text-text-secondary text-sm">Find your perfect strain based on effects you want</p>
            </Link>
            <Link href="/tools/strain-compare" className="card p-6 block hover:shadow-md transition-shadow">
              ...
              <p className="text-text-secondary text-sm">Compare two strains side by side</p>
            </Link>
          </div>
        </section>
